...
-- size of the gap between pipes is arbitrary, no longer coded to a fixed 90
local GAP_HEIGHT
...
function PipePair:init(y)
    ...
    -- Randomise the gap between the pipes. Vertical space random between values of 90 and 130 (ASSIGNMENT REQUIREMENT)
